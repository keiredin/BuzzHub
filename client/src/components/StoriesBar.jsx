    ...
    <div className="w-screen sm:w-[calc(100vw-240px)] lg:max-w-2xl no-scrollbar overflow-x-auto px-4">
      <div className="flex gap-4 pb-5">
        ...
        <div
          ...
          className=" rounded-lg shadow min-w-30 max-w-30 max-h-40 aspect-[3/4] cursor-pointer hover:shadow-lg 
        ...
        transition-all duration-200  bg-gradient-to-b from-indigo-50 to-purple-600 hover:from-indigo-700 hover:to-indigo-800
        active:scale-95 "
          >
            <img
